...
<div class="claim-row">
  ...
  <div class="evidence">Supported by: <span>Parts D and F</span>, all four generated figures and the protocol card show BioForge running against the 17-run dataset from the published study and achieving modeling accuracy consistent with the 49.1% experimentally validated improvement reported in Okedi et al. (2024).</div>
</div>
